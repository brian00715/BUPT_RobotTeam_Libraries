...
// 大疆电机跑速度环的PID参数
PID_t RM_Speed_PID[4] = {1.4, 0.9, 0.6, 0, 0, 5000, 0, 0.005}; // = {1.4,0.9,0.6,0,0,5000,0,0.005};
// 大疆电机跑位置环的PID参数
PID_t RM_Position_PID[4] = {0.13, 0, 0.082, 0, 0, 5000, 0, 0.005}; // = {0.13,0,0.082,0,0,5000,0,0.005};
